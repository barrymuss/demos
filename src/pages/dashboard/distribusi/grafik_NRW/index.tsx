		...
		>
			<Tabset
				...
				panel={[
							...
							<Grid>
								<Grid.Col>
									<Card
										title={'Grafik NRW'}
										subtitle={
											empty ? `terlampir data NRW pada tahun ${filter.tahun}` : 'silahkan atur filter terlebih dahulu'
										}
										notshadow
										notpadding
									>
					...
					{
						title: 'Grafik NRW YTD',
						disabled: !empty,
						content: (
							<Grid>
								<Grid.Col>
									<Card
										title={empty && 'Grafik NRW YTD'}
										subtitle={empty && `terlampir data NRW YTD pada tahun ${filter.tahun}`}
										notshadow
										notpadding
									>
										<DistribusiGrafik
								...
								<Grid.Col>
									<Card
										...
										subtitle={
											empty
												? `terlampir data NRW YTD pada tahun ${filter.tahun}`
